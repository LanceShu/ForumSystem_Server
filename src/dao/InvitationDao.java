...
public class InvitationDao implements IInvitation {
    ...
    @Override
    public String publishInvitation(String author, String content) {
        ...
        try {
            statement = manager.prepareStatement("INSERT INTO all_invitation(iauthor, idate, icontent, iscollected) VALUES (\""+author+"\",\""+date+"\",\""+content+"\","+false+")");
            ...
            statement = manager.prepareStatement("INSERT INTO own_invitation(oauthor, odate, ocontent, iscollected) VALUES (\""+author+"\",\""+date+"\",\""+content+"\","+false+")");
            result = statement.execute();
    ...
    @Override
    public String collectInvitation(String author, String owner, String date, String content) {
        Connection manager = SQLConnectionManager.getInstance().getConnection();
        PreparedStatement statement = null;
        Status status = new Status();
        boolean result;
        try {
            statement = manager.prepareStatement("INSERT INTO favourite_invitation(fauthor,fowner,fdate,fcontent) VALUES (\""+author+"\",\""+owner+"\",\""+date+"\",\""+content+"\")");
            result = statement.execute();
            status.setStatus(result ? "failure" : "success");
